...
<body>
    ...
    <div class="container d-flex">
        <form action="" method="POST" class="m-auto bg-white p-5 rounded-sm shadow-lg w-form">
            ...
            <div class="form-group">
                <label for="examplePassword1">Password confirmation</label>
                <input name="password_confirmation" type="password" class="form-control" id="examplePassword1" aria-describedby="emailHelp" placeholder="Password">
